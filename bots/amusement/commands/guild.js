...
generateGlobalCommand('guild', 'Top Level Guild')
    .subCommand('info', 'Display info about the current guild')
    .close()
    ...
    .minValue(1)
    .close()
    .subCommandGroup('set', 'Top Level Set')
    .subCommand('tax', 'Set the claim tax for the current guild')
    .integer('tax_percentage', 'A whole number equal to the tax percent you want to set')
    .minValue(0)
    .maxValue(100)
    .close()
    ...
    .required()
    .close()
    .subCommand('remove', 'Remove a user from the guild managers list')
    .userID('The user you want to remove from managers')
    .required()
    .close()
    .close()
