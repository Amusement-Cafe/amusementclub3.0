const dailies = [
    {
        ...
        min_level: 0,
        actions: ['claim cards'],
        check: (ctx, user, stats) => stats.totalRegularClaims >= 4,
    ...
    },
    {
        ...
        min_level: 10,
        actions: ['claim', 'cl'],
        check: (ctx, user, stats) => stats.totalRegularClaims >= 8,
        resolve: (ctx, user, stats) => {
            user.exp += 1500
            user.xp += 5
            user.lemons += 30
    ...
    },
    {
        ...
        min_level: 15,
        actions: ['auc', 'auction'],
        check: (ctx, user, stats) => stats.auctionBid >= 2,
        resolve: (ctx, user, stats) => {
            user.exp += 1250
            user.xp += 2
            user.lemons += 15
    ...
    },
    {
        ...
        min_level: 50,
        actions: ['auc', 'auction'],
        check: (ctx, user, stats) => stats.auctionBid >= 4,
        resolve: (ctx, user, stats) => {
            user.exp += 2000
            user.xp += 8
            user.lemons += 30
    ...
    },
    {
        ...
        min_level: 15,
        actions: ['tag'],
        check: (ctx, user, stats) => stats.tagsCreated >= 2,
        resolve: (ctx, user, stats) => {
            user.exp += 400
            user.xp += 2
            stats.tomatoin += 400
    ...
    },
    {
        ...
        min_level: 25,
        actions: ['tag'],
        check: (ctx, user, stats) => stats.tagsCreated >= 4,
        resolve: (ctx, user, stats) => {
            user.exp += 800
            user.xp += 4
            stats.tomatoin += 800
    ...
    },
    {
        ...
        min_level: 0,
        actions: ['rate'],
        check: (ctx, user, stats) => stats.cardsRated >= 2,
        resolve: (ctx, user, stats) => {
            user.exp += 250
            user.xp += 2
            user.lemons += 15
    ...
    },
    {
        ...
        min_level: 10,
        actions: ['rate'],
        check: (ctx, user, stats) => stats.cardsRated >= 5,
        resolve: (ctx, user, stats) => {
            user.exp += 500
            user.xp += 5
            user.lemons += 30
...
const weeklies = [
    {
        ...
        min_level: 0,
        actions: ['claim cards'],
        progress: (ctx, user, stats, extra) => `[${extra.totalRegularClaims}/28]`,
        check: (ctx, user, stats, extra) => extra.totalRegularClaims >= 28,
        resolve: (ctx, user, stats) => {
            user.exp += 750
            stats.tomatoin += 750
            user.lemons += 60
    ...
    },
    {
        ...
        min_level: 20,
        actions: ['claim cards'],
        progress: (ctx, user, stats, extra) => `[${extra.totalRegularClaims}/56]`,
        check: (ctx, user, stats, extra) => extra.totalRegularClaims >= 56,
        resolve: (ctx, user, stats) => {
            user.exp += 1000
            stats.tomatoin += 1000
            user.lemons += 120
    ...
    },
    {
        ...
        min_level: 0,
        actions: [],
        progress: (ctx, user, stats, extra) => `[${extra.auctionBid}/12]`,
        check: (ctx, user, stats, extra) => extra.auctionBid >= 12,
        resolve: (ctx, user, stats) => {
            user.exp += 750
            stats.tomatoin += 750
            user.lemons += 60
    ...
    },
    {
        ...
        min_level: 0,
        actions: [],
        progress: (ctx, user, stats, extra) => `[${extra.auctionBid}/18]`,
        check: (ctx, user, stats, extra) => extra.auctionBid >= 18,
        resolve: (ctx, user, stats) => {
            user.exp += 1000
            stats.tomatoin += 1000
            user.lemons += 120
...
const monthlies = [
    {
        ...
        min_level: 0,
        actions: ['claim cards'],
        progress: (ctx, user, stats, extra) => `[${extra.totalRegularClaims}/120]`,
        check: (ctx, user, stats, extra) => extra.totalRegularClaims >= 120,
        resolve: (ctx, user, stats) => {
            user.exp += 3000
            stats.tomatoin += 3000
            user.lemons += 240
    ...
    },
    {
        ...
        min_level: 10,
        actions: ['claim cards'],
        progress: (ctx, user, stats, extra) => `[${extra.totalRegularClaims}/240]`,
        check: (ctx, user, stats, extra) => extra.totalRegularClaims >= 240,
        resolve: (ctx, user, stats) => {
            user.exp += 6000
            stats.tomatoin += 6000
            user.lemons += 480
    ...
    },
    {
        ...
        min_level: 0,
        actions: ['auction bid'],
        progress: (ctx, user, stats, extra) => `[${extra.auctionBid}/30]`,
        check: (ctx, user, stats, extra) => extra.auctionBid >= 30,
        resolve: (ctx, user, stats) => {
            user.exp += 7500
            stats.tomatoin += 7500
            user.lemons += 240
    ...
    },
    {
        ...
        min_level: 0,
        actions: ['auction bid'],
        progress: (ctx, user, stats, extra) => `[${extra.auctionBid}/45]`,
        check: (ctx, user, stats, extra) => extra.auctionBid >= 45,
        resolve: (ctx, user, stats) => {
            user.exp += 10000
